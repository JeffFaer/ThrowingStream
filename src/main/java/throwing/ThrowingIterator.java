...
public interface ThrowingIterator<E, X extends Throwable> {
    public interface PrimitiveIterator<T, T_CONS, X extends Throwable> extends
    ...
    public interface OfInt<X extends Throwable> extends
            PrimitiveIterator<Integer, ThrowingIntConsumer<X>, X> {
    ...
    public interface OfLong<X extends Throwable> extends
            PrimitiveIterator<Long, ThrowingLongConsumer<X>, X> {
    ...
    public interface OfDouble<X extends Throwable> extends
            PrimitiveIterator<Double, ThrowingDoubleConsumer<X>, X> {

...
class UncheckedSpliterator<T, S extends ThrowingSpliterator<T, X>, X extends Throwable> extends UncheckedBridge<S, X>
    ...
    static class OfLong<X extends Throwable> extends UncheckedSpliterator<Long, ThrowingSpliterator.OfLong<X>, X>
    ...
    static class OfDouble<X extends Throwable> extends UncheckedSpliterator<Double, ThrowingSpliterator.OfDouble<X>, X>
        ...
        public Spliterator.OfDouble trySplit() {
            return new UncheckedSpliterator.OfDouble<>(getDelegate().trySplit(), getExceptionClass());
        }

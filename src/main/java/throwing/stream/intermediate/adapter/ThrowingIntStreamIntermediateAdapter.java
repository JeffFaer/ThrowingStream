...
public interface ThrowingIntStreamIntermediateAdapter<X extends Throwable, XD extends Throwable, ID extends ThrowingIntStreamIntermediate<XD, ID, LD, DD>, LD extends ThrowingLongStreamIntermediate<XD, ID, LD, DD>, DD extends ThrowingDoubleStreamIntermediate<XD, ID, LD, DD>, IS extends ThrowingIntStreamIntermediate<X, IS, LS, DS>, LS extends ThrowingLongStreamIntermediate<X, IS, LS, DS>, DS extends ThrowingDoubleStreamIntermediate<X, IS, LS, DS>> extends

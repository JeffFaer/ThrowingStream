...
public interface ThrowingLongPredicate<X extends Throwable> {
  ...
  default public <Y extends Throwable> ThrowingLongPredicate<Y> orTry(
      ThrowingLongPredicate<? extends Y> f) {
    return orTry(f, null);
  }

  default public <Y extends Throwable> ThrowingLongPredicate<Y> orTry(
      ThrowingLongPredicate<? extends Y> f, @Nullable Consumer<? super Throwable> thrown) {
    return t -> {

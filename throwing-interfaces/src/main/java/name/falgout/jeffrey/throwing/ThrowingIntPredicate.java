...
public interface ThrowingIntPredicate<X extends Throwable> {
  ...
  default public <Y extends Throwable> ThrowingIntPredicate<Y>
      orTry(ThrowingIntPredicate<? extends Y> f) {
    return orTry(f, null);
  }

  default public <Y extends Throwable> ThrowingIntPredicate<Y>
      orTry(ThrowingIntPredicate<? extends Y> f, @Nullable Consumer<? super Throwable> thrown) {
    return t -> {

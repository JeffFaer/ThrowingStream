...
public interface RethrowChain<X extends Throwable, Y extends Throwable> extends Chain<X, Y> {
  ...
  public static final Function<Throwable, Error> END_FUNCTION =
      RethrowChain.<Throwable, Error> start().finish();
  ...
  public static <Y extends Throwable> RethrowChain<Throwable, Y> start(Class<Y> clazz) {
  ...
  default public <Z extends Throwable> RethrowChain<X, Z>
      rethrow(Function<? super Y, ? extends Z> mapper) {

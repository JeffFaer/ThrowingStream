...
public interface ThrowingDoublePredicate<X extends Throwable> {
  ...
  default public <Y extends Throwable> ThrowingDoublePredicate<Y>
      orTry(ThrowingDoublePredicate<? extends Y> f) {
    return orTry(f, null);
  }

  default public <Y extends Throwable> ThrowingDoublePredicate<Y>
      orTry(ThrowingDoublePredicate<? extends Y> f, @Nullable Consumer<? super Throwable> thrown) {
    return t -> {

...
public interface ThrowingIntUnaryOperator<X extends Throwable> {
  ...
  default public <Y extends Throwable> ThrowingIntUnaryOperator<Y>
      orTry(ThrowingIntUnaryOperator<? extends Y> f) {
    return orTry(f, null);
  }

  default public <Y extends Throwable> ThrowingIntUnaryOperator<Y>
      orTry(ThrowingIntUnaryOperator<? extends Y> f, @Nullable Consumer<? super Throwable> thrown) {
    return t -> {
